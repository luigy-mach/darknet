...
void my_draw_detections_testv3(image im, detection *dets, int num, float thresh, char **names, image **alphabet, int classes, FILE * demo_filePointer, GList** demo_list_tracking_obj, char* demo_basename_filename);
